      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-700/50">
          ...
          <div className="relative h-48 overflow-hidden">
            ...
            <img
              src="https://images.unsplash.com/photo-1619643419910-1d6c7fd4e1e3?auto=format&fit=crop&w=900&q=80"
              alt="Security Banner"
          ...
          <div className="px-8 py-8">
            ...
            <div className="space-y-5">
              ...
              >
                <p>
                  Demo credentials: <br />
                  <span className="text-red-400">admin/123</span> or <span className="text-red-400">user/123</span>
                </p>
                <p className="mt-3">
